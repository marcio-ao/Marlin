...
void Endstops::init() {
    ...
    #if ENABLED(PULLUP_BACKLASH_COMPENSATION)
        SET_INPUT_PULLUP(BACKLASH_COMPENSATION_PIN);
      #elif ENABLED(PULLDOWN_BACKLASH_COMPENSATION)
        SET_INPUT_PULLDOWN(BACKLASH_COMPENSATION_PIN);
      #else
        SET_INPUT(BACKLASH_COMPENSATION_PIN);
      #endif
  #endif
