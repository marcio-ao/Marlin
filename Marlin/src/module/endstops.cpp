...
void Endstops::init() {
    ...
    #if ENABLED(CALIBRATION_CUBE_PROBE_PULLUP)
      SET_INPUT_PULLUP(CALIBRATION_CUBE_PROBE_PIN);
    #elif ENABLED(CALIBRATION_CUBE_PROBE_PULLDOWN)
      SET_INPUT_PULLDOWN(CALIBRATION_CUBE_PROBE_PIN);
    #else
      SET_INPUT(CALIBRATION_CUBE_PROBE_PIN);
    #endif
  #endif
